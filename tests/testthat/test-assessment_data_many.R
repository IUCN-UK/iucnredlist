test_that("assessment_data_many returns assessment data for a collection of assessment ids", {
  httptest2::with_mock_dir("assessment_data_many_2911619_58307800_178423675", {
    ...
    expect_equal(result[[1]]$assessment_id, dplyr::tibble(value = 2911619))
    expect_equal(result[[2]]$assessment_id, dplyr::tibble(value = 58307800))
    expect_equal(result[[3]]$assessment_id, dplyr::tibble(value = 178423675))
  })
})
